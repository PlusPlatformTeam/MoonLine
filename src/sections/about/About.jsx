      ...
      <div className="flex flex-row w-full">
        <div className="lg:w-5/12 w-full mt-16 mx-12">
          <div className="flex flex-row ">
            ...
            <h1 className="text-white font-bold text-3xl mt-3 ">درباره ما </h1>
          </div>
          ...
          <button
            type="button"
            class="text-white my-36 bg-yellow-500 hover:bg-yellow-300 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900"
          >
            نمونه کارهای بیشتر
          </button>
        </div>
